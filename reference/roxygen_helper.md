...
million output tokens. So, using the recommended model, **roxygen
helpers cost around \$4 for every 1,000 generated roxygen documentation
entries**. GPT-4o Mini, by contrast, doesn't tend to infer argument
types correctly as often and often fails to line-break properly, but
*does* usually return syntactically valid documentation entries, and it
would cost around 20 cents per 1,000 generated roxygen documentation
entries.

## Gallery

This section includes a handful of examples "from the wild" and are
generated with the recommended model, Claude Sonnet 3.5.
