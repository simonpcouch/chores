...
output tokens. So, using the recommended model, **roxygen helpers cost
around \$2 for every 1,000 generated roxygen documentation entries**.
GPT-4.1-mini, by contrast, doesn't tend to infer argument types
correctly as often and often fails to line-break properly, but *does*
usually return syntactically valid documentation entries, and it would
cost around 80 cents per 1,000 generated roxygen documentation entries.

## Gallery

This section includes a handful of examples "from the wild" and are
generated with the recommended model, Claude Haiku 4.5.
