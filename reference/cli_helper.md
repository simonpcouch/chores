...
output tokens. So, using the recommended model, **cli helpers cost
around \$5 for every 1,000 refactored pieces of code**. GPT-4.1-mini, by
contrast, doesn't tend to get cli markup classes right but *does* return
syntactically valid calls to cli functions, and it would cost around \$2
per 1,000 refactored pieces of code.
