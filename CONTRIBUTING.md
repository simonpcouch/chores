...
This outlines how to propose a change to chores. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("simonpcouch/chores", fork = TRUE)`.
...
Please note that the chores project is released with a [Contributor Code
of Conduct](https://simonpcouch.github.io/chores/CODE_OF_CONDUCT.md). By
