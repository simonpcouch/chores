...
[Functions prefixed
with](https://simonpcouch.github.io/chores/dev/reference/prompt.md)
...
[`vignette("custom", package = "chores")`](https://simonpcouch.github.io/chores/dev/articles/custom.md),for
...
#> ℹ If desired, create it with `dir.create("/tmp/RtmpJ9w2si/file19647a87d5fc",
#>   recursive = TRUE)`.
