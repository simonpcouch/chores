...
#' **testthat helpers cost around $2 for every 1,000 refactored pieces of code**. GPT-4.1-mini,
#' by contrast, doesn't tend to get many pieces of formatting right and
...
#' 65 cents per 1,000 refactored pieces of code.
#'
#' @section Gallery:
#'
